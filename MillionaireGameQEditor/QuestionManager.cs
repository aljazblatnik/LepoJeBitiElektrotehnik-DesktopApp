...
namespace Millionaire
{
    public partial class QEditor : Form
    {
        ...
        public static SqlConnection c = new SqlConnection
                    (String.Format
                    (@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename={0}\{1}.mdf;Integrated Security=True;Connect Timeout=60", Application.StartupPath, "dbMillionaire"));
        ...
        public void EditDB()
        {
            ...
            if (stLevel.Text == "Lvl2")
            {
                if (Convert.ToInt32(dtLevel1.CurrentRow.Cells[0].Value) == 0)
                {
                    MessageBox.Show("Najprej morate izbrati vprašanje!", "Info", MessageBoxButtons.OK, MessageBoxIcon.Information);
                }
                else
                {
                    ...
                    edit.cbUsed.Checked = (bool)this.dtLevel1.CurrentRow.Cells[8].Value;
            ...
            else if (stLevel.Text == "Lvl3")
            {
                ...
                else
                {
                    ...
                    edit.cbUsed.Checked = (bool)this.dtLevel2.CurrentRow.Cells[8].Value;
            ...
            else if (stLevel.Text == "Lvl4")
            {
                ...
                else
                {
                    ...
                    edit.cbUsed.Checked = (bool)this.dtLevel3.CurrentRow.Cells[8].Value;
                    edit.txtNote.Text = this.dtLevel3.CurrentRow.Cells[9].Value.ToString();
                }

            }
            else if (stLevel.Text == "Lvl5")
            {
                ...
                else
                {
                    ...
                    edit.cbUsed.Checked = (bool)this.dtLevel4.CurrentRow.Cells[8].Value;
                    edit.txtNote.Text = this.dtLevel4.CurrentRow.Cells[9].Value.ToString();
                }
            }
            else if (stLevel.Text == "Lvl1")
            {
                ...
                else
                {
                    ...
                    edit.cbUsed.Checked = (bool)this.dtLevel0.CurrentRow.Cells[8].Value;
        ...
        public void DeleteDB()
        {
            ...
            {
                MessageBox.Show("Prosim izberite vprašanje, ki ga želite odstraniti", "Odstrani vprašanje", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
            else
            {
                DialogResult remDiag = MessageBox.Show("Ste prepričani, da želite odstraniti izbrano vprašanje?", "Odstrani vprašanje", MessageBoxButtons.YesNo, MessageBoxIcon.Warning);
        ...
        public void ChangeLevelDB()
        {
            ...
            if (stLevel.Text == "Lvl2")
            {
                ...
                {
                    change.lblOldLevel.Text = "Nivo 2";
                    change.cmbNewLevel.Text = "Nivo 2";
            ...
            else if (stLevel.Text == "Lvl3")
            {
                ...
                {
                    change.lblOldLevel.Text = "Nivo 3";
                    change.cmbNewLevel.Text = "Nivo 3";
            ...
            else if (stLevel.Text == "Lvl4")
            {
                ...
                {
                    change.lblOldLevel.Text = "Nivo 4";
                    change.cmbNewLevel.Text = "Nivo 4";
            ...
            else if (stLevel.Text == "Lvl5")
            {
                ...
                {
                    change.lblOldLevel.Text = "Nivo 5";
                    change.cmbNewLevel.Text = "Nivo 5";
            ...
            else if (stLevel.Text == "Lvl1")
            {
                ...
                {
                    change.lblOldLevel.Text = "Nivo 1";
                    change.cmbNewLevel.Text = "Nivo 1";
                    change.QuestionID = Convert.ToInt32(this.dtLevel0.CurrentRow.Cells[0].Value);
                    change.question = this.dtLevel0.CurrentRow.Cells[1].Value.ToString();
                    change.A = this.dtLevel0.CurrentRow.Cells[2].Value.ToString();
                    change.B = this.dtLevel0.CurrentRow.Cells[3].Value.ToString();
                    change.C = this.dtLevel0.CurrentRow.Cells[4].Value.ToString();
                    change.D = this.dtLevel0.CurrentRow.Cells[5].Value.ToString();
                    change.Correct = this.dtLevel0.CurrentRow.Cells[6].Value.ToString();
                    change.Note = this.dtLevel0.CurrentRow.Cells[9].Value.ToString();
                    change.ShowDialog();
                }
            }
        }
        ...
        private void tsmenuActionsResetAllQuestions_Click_1(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                MessageBox.Show("Vsa vprašanja uspešno ponastavljena!", "Info", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
            catch (Exception ex)
            {
        ...
        private void resetLevel1UsedQuestionsToolStripMenuItem_Click_1(object sender, EventArgs e)
        {
            ...
            try
            {
                c.Open();
                cmd1.ExecuteNonQuery();
                MessageBox.Show("Vsa vprašanja 2. nivoja uspešno ponastavljena!", "Info", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
            catch (Exception ex)
            {
                MessageBox.Show(ex.Message, "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
        ...
        private void resetLevel2UsedQuestionsToolStripMenuItem_Click_1(object sender, EventArgs e)
        {
            ...
            try
            {
                c.Open();
                cmd2.ExecuteNonQuery();
                MessageBox.Show("Vsa vprašanja 3. nivoja uspešno ponastavljena!", "Info", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
            catch (Exception ex)
            {
                MessageBox.Show(ex.Message, "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
        ...
        private void resetLevel3UsedQuestionsToolStripMenuItem_Click_1(object sender, EventArgs e)
        {
            ...
            try
            {
                c.Open();
                cmd3.ExecuteNonQuery();
                MessageBox.Show("Vsa vprašanja 4. nivoja uspešno ponastavljena!", "Info", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
            catch (Exception ex)
            {
                MessageBox.Show(ex.Message, "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
        ...
        private void resetLevel4UsedQuestionsToolStripMenuItem_Click_1(object sender, EventArgs e)
        {
            ...
            try
            {
                c.Open();
                cmd4.ExecuteNonQuery();
                MessageBox.Show("Vsa vprašanja 5. nivoja uspešno ponastavljena!", "Info", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
            catch (Exception ex)
            {
                MessageBox.Show(ex.Message, "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
        ...
        private void resetFastestFingerUsedQuestionsToolStripMenuItem_Click_1(object sender, EventArgs e)
        {
            ...
            try
            {
                c.Open();
                cmd0.ExecuteNonQuery();
                MessageBox.Show("Vsa vprašanja 1. nivoja uspešno ponastavljena!", "Info", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
            catch (Exception ex)
            {
                MessageBox.Show(ex.Message, "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
