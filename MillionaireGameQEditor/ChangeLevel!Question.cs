...
namespace MillionaireGameQEditor
{
    ...
    public partial class frmChangeLevel : Form
    {
        ...
        private void btnYes_Click(object sender, EventArgs e)
        {
            ...
            else if (cmbNewLevel.Text == "Nivo 2")
            {
                levelType = "Lvl2";
                QEditor.c.Open();
            ...
            else if (cmbNewLevel.Text == "Nivo 3")
            {
                levelType = "Lvl3";
                QEditor.c.Open();
            ...
            else if (cmbNewLevel.Text == "Nivo 4")
            {
                levelType = "Lvl4";
                QEditor.c.Open();
            ...
            else if (cmbNewLevel.Text == "Nivo 5")
            {
                levelType = "Lvl5";
                QEditor.c.Open();
            ...
            if (lblOldLevel.Text == "Nivo 1")
            {
                string strR = "DELETE FROM questions_Level0 WHERE Id = @Id";
                cmdRemove = new SqlCommand(strR, QEditor.c);
                cmdRemove.Parameters.AddWithValue("@Id", QuestionID);
                cmdRemove.ExecuteNonQuery();
                QEditor.c.Close();
            }
            else if(lblOldLevel.Text == "Nivo 2")
            {
            ...
            else if (lblOldLevel.Text == "Nivo 3")
            {
            ...
            else if (lblOldLevel.Text == "Nivo 4")
            {
            ...
            else if (lblOldLevel.Text == "Nivo 5")
            {
