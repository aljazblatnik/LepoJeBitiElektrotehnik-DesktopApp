Public Class TVControlPnl
    ...
    Private Sub tmrStrap_Tick(sender As Object, e As EventArgs) Handles tmrStrap.Tick
        ...
        ControlPanel.cbWinningPanel.Checked = True
    ...
    Private Sub pnlPL1_Paint(sender As Object, e As PaintEventArgs)

    End Sub

    Private Sub txtPL7_Points_Click(sender As Object, e As EventArgs)

    End Sub

    Private Sub txtFFFOrder1_Click(sender As Object, e As EventArgs)

    End Sub

    Private Sub picSW_Click(sender As Object, e As EventArgs)

    End Sub

    Private Sub pic50_Click(sender As Object, e As EventArgs)
    ...
    Private Sub picVO_Click(sender As Object, e As EventArgs)

    End Sub

    Private Sub pnlQuestion_Paint(sender As Object, e As PaintEventArgs) Handles pnlQuestion.Paint
