Public Class SOUND
    ...
    Private Function GetFile(ByVal Id As Integer) As String
        ...
        Select Case Id
            ...
            Case 45
                path = Application.StartupPath + "\Sounds\game_over.mp3"
            Case 46
                path = Application.StartupPath + "\Sounds\commercial_in.mp3"
            Case 47
                path = Application.StartupPath + "\Sounds\commercial_out.mp3"
            Case 48
                path = Application.StartupPath + "\Sounds\close_underscore.mp3"
            Case 49
                path = Application.StartupPath + "\Sounds\host_entrance.mp3"
            Case 50
                path = Application.StartupPath + "\Sounds\trailer_long.mp3"
            Case 51
                path = Application.StartupPath + "\Sounds\trailer_short.mp3"
        End Select
